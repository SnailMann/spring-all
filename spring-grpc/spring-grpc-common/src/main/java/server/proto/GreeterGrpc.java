...
public final class GreeterGrpc {
  ...
  public static final String SERVICE_NAME = "server.proto.Greeter";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<server.proto.User.HelloRequest,
      server.proto.User.HelloResponse> getSayHiMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHi",
      requestType = server.proto.User.HelloRequest.class,
      responseType = server.proto.User.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<server.proto.User.HelloRequest,
      server.proto.User.HelloResponse> getSayHiMethod() {
    io.grpc.MethodDescriptor<server.proto.User.HelloRequest, server.proto.User.HelloResponse> getSayHiMethod;
    if ((getSayHiMethod = GreeterGrpc.getSayHiMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHiMethod = GreeterGrpc.getSayHiMethod) == null) {
          GreeterGrpc.getSayHiMethod = getSayHiMethod =
              io.grpc.MethodDescriptor.<server.proto.User.HelloRequest, server.proto.User.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHi"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  server.proto.User.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  server.proto.User.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHi(server.proto.User.HelloRequest request,
        io.grpc.stub.StreamObserver<server.proto.User.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                server.proto.User.HelloRequest,
                server.proto.User.HelloResponse>(
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
    ...
    /**
     */
    public server.proto.User.HelloResponse sayHi(server.proto.User.HelloRequest request) {
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<server.proto.User.HelloResponse> sayHi(
        server.proto.User.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HI:
          serviceImpl.sayHi((server.proto.User.HelloRequest) request,
              (io.grpc.stub.StreamObserver<server.proto.User.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return server.proto.User.getDescriptor();
    }
